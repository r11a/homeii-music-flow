      ...
      <div class="card ${rtl ? "rtl" : ""} theme-${visualTheme}${theme === "custom" ? " theme-custom" : ""}" style="--v2-custom-text:${this._state.mobileCustomTextTone === "dark" ? "#1f2633" : "#ffffff"};">
        <aside class="sidebar">
          <div class="brand">
            ...
            <div>
              <div class="brand-title">HOMEii Browser</div>
      ...
      <div class="immersive-shell ${rtl ? "rtl" : ""}">
        ...
        <div class="immersive-header">
          ...
          <div class="immersive-meta">
            <div class="immersive-kicker">HOMEii Browser</div>
...
const HOMEII_CARD_VERSION = "4.100";
const HOMEII_BROWSER_EDITOR_TAG = "ma-browser-card-editor-v4100";
const HOMEII_MOBILE_EDITOR_TAG = "homeii-music-flow-editor-v5000-clean";
...
function getMobileEditorTexts() {
  ...
  return {
    ...
    helpers: {
      ...
      mobile_compact_mode: he ? "מתאים את הכרטיס לדשבורד נייד צפוף עם מרווחים ואלמנטים קטנים יותר." : "Optimizes the card for a tighter mobile dashboard with smaller spacing and controls.",
...
if (!window.customCards.some((c) => c.type === "ma-browser-card")) {
  window.customCards.push({
    ...
    name: "HOMEii Browser",
    description: `HOMEii Browser for Music Assistant in Home Assistant v${HOMEII_CARD_VERSION}`,
    preview: true,
  });
}
...
if (!window.customCards.some((c) => c.type === "custom:homeii-music-flow")) {
  window.customCards.push({
    ...
    description: `Mobile-first Music Assistant player with stacked in-card menu v${HOMEII_CARD_VERSION}`,
    preview: true,
  });
}
