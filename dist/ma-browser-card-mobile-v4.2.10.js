...
const HOMEII_CARD_VERSION = "4.2.10";
        ...
        <div class="compact-content">
          ...
          <div class="compact-stage">
            <div class="compact-cover-wrap">
              ...
              <button class="compact-cover art-stack-view" id="npArt" title="${this._m("Browse and play", "דפדוף וניגון")}">
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        * { box-sizing:border-box; }
        ...
        .compact-cover.art-stack-view {
          min-height:0;
          isolation:isolate;
          overflow:hidden;
        }
        .compact-cover .art-stack-viewport,
        .compact-cover .art-stack-container {
          min-height:100%;
          height:100%;
        }
        .compact-cover .art-stack-slide {
          width:100%;
          inset:0;
          left:0;
        ...
        .compact-cover .art-stack-slide.prev,
        .compact-cover .art-stack-slide.next {
          opacity:0;
          pointer-events:none;
        }
        .compact-cover .art-stack-card {
          width:100%;
          height:100%;
          border-radius:28px;
          background:transparent;
        ...
        .compact-cover .art-stack-card img {
          width:100%;
          height:100%;
          display:block;
          object-fit:contain;
...
.theme-light .player-mini-value{color:#435066!important;}
  ...
  _syncNowPlayingUI() {
    ...
    const renderCompactTile = ({ title = "", subtitle = "", art = "", icon = "music_note", duration = 0, position = 0, emptyAction = "" }) => {
      ...
      if (artHost) {
        if (art) this._refreshMobileArtStack(true);
        else artHost.innerHTML = `<span class="compact-cover-placeholder">${this._iconSvg("wand")}</span>`;
      }
