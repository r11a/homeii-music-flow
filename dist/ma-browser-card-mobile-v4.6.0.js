...
.card.layout-tablet .active-player-chip .bars,.card.layout-tablet .active-player-card .bars{display:none!important;}
  ...
  _syncRecentHistoryUi() {
    ...
    host.innerHTML = `
      <div class="history-shelf-head">${this._esc(this._m("Recently played", "נוגן לאחרונה"))}</div>
      <div class="history-shelf-row">
...
const HOMEII_CARD_VERSION = "4.6.0";
...
class MABrowserCardMobile extends MABrowserCard {
  ...
  _build() {
    ...
    const bottomHtml = `
        ...
        <div class="history-shelf" id="historyShelf" hidden></div>
      </div>`;
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        * { box-sizing:border-box; }
        ...
        .history-shelf-row::-webkit-scrollbar {
          display:none;
        }
        .history-chip {
          min-width:144px;
        ...
        .theme-light .history-shelf-head {
          color:#7b889b;
        }
