...
const HOMEII_CARD_VERSION = "4.2.1";
        ...
        <div class="compact-content">
          ...
          <div class="compact-body">
            <div class="compact-cover-wrap">
              ...
              <button class="compact-cover" id="npArt" title="${this._m("Expand player", "הרחב נגן")}">
                <img class="compact-cover-image" id="compactCoverImage" alt="">
                <span class="compact-cover-placeholder">${this._iconSvg("music_note")}</span>
              </button>
            </div>
      ...
      <style>
        ...
        * { box-sizing:border-box; }
        ...
        .compact-player-chip.is-playing {
          border-color:rgba(241,186,83,.34);
          box-shadow:
        ...
        .theme-light .compact-backdrop-art {
          opacity:.42;
          filter:blur(52px) saturate(1.14) brightness(1.08);
        }
        ...
        .theme-light .compact-volume-slider {
        ...
        .card.rtl .compact-chrome,
        .card.rtl .compact-main {
          direction:rtl;
          text-align:right;
        }
        .card.rtl .compact-controls {
          flex-direction:row;
        }
        @media (max-width: 760px) {
          .compact-shell {
