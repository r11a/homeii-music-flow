...
const HOMEII_CARD_VERSION = "4.2.29";
...
.theme-light .player-mini-value{color:#435066!important;}
    ...
    this.shadowRoot.querySelectorAll("[data-mainbar-action]").forEach((btn) => btn.addEventListener("click", () => {
      ...
      if (action === "library") this._openMobileMenu("library_playlists");
        ...
        this._state.mobilePlayerPickerMode = "players";
        this._openPlayerModal();
      }
    ...
    this.$("activePlayersBubble")?.addEventListener("click", () => {
      this._state.mobilePlayerPickerMode = "players_active";
      this._openPlayerModal();
    });
    ...
    this.$("mobileMenuTitle")?.addEventListener("click", (e) => {
      if (e.currentTarget?.dataset?.menuTitleAction === "players") {
        this._state.mobilePlayerPickerMode = "players";
        this._openPlayerModal();
      }
    });
  ...
  async _renderMobileMenu() {
    ...
    if (this._state.menuPage === "players" || this._state.menuPage === "players_active") {
      this._state.menuPage = "main";
    }
