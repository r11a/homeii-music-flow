...
const HOMEII_CARD_VERSION = "4.7.7";
...
.control-room-grid-wrap{min-height:0;height:100%;padding:24px 28px 92px;display:flex;align-items:stretch;justify-content:center;}
...
.control-room-dock{position:absolute;inset-inline-start:50%;inset-block-end:0;display:flex;align-items:center;justify-content:center;gap:14px;flex-wrap:nowrap;max-width:calc(100% - 16px);margin-inline:auto;padding:14px 18px 18px;border-radius:28px 28px 0 0;border:1px solid rgba(255,255,255,.14);border-bottom:none;background:rgba(9,12,18,.52);backdrop-filter:blur(24px);-webkit-backdrop-filter:blur(24px);box-shadow:0 12px 34px rgba(0,0,0,.24);transform:translateX(-50%);}
...
@media (max-width: 1280px){
  ...
  .control-room-grid-wrap{padding:24px 20px 84px;}
  .control-room-dock{inset-block-end:0;padding:12px 14px 15px;gap:10px;max-width:calc(100% - 8px);}
