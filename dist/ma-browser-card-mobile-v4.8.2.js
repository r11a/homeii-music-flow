...
const HOMEII_CARD_VERSION = "4.8.2";
...
.player-sub { margin-top:1px; font-size:calc(11px * var(--v2-font-scale)); color:rgba(255,255,255,.72); white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
        ...
        .art-stack-slide.prev {
          transform:translateX(calc(-102% + (var(--art-drag-x) * .18))) scale(.8);
          opacity:.42;
        }
        .art-stack-slide.next {
          transform:translateX(calc(2% + (var(--art-drag-x) * .18))) scale(.8);
          opacity:.42;
        }
        .art-stack-slide.prev .art-stack-card {
          opacity:1;
          filter:saturate(.8) brightness(.92);
          transform:perspective(900px) rotateY(14deg) scale(.88);
        }
        ...
        .card.layout-tablet .art-stack-slide.prev {
          transform:translateX(calc(-102% + (var(--art-drag-x) * .16))) scale(.8);
          opacity:.38;
        }
        .card.layout-tablet .art-stack-slide.next {
          transform:translateX(calc(2% + (var(--art-drag-x) * .16))) scale(.8);
          opacity:.38;
        }
        .card.layout-tablet .art-stack-slide.prev .art-stack-card {
          transform:perspective(1080px) rotateY(14deg) scale(.86);
        }
        ...
        .card.layout-tablet.tablet-auto-fit.tablet-fit-dense .art-stack-container {
          min-height:clamp(210px, 22vw, 276px);
        }
        ...
        @media (max-width:600px) {
          ...
          .mobile-art-actions { width:auto; margin-top:-4px; padding:0; gap:8px; }
...
.mobile-art-actions{position:relative!important;left:auto!important;right:auto!important;transform:none!important;inset-inline:auto!important;inset-block-end:auto!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:10px!important;flex-wrap:wrap!important;margin-top:-6px!important;padding:0!important;border-radius:0!important;background:transparent!important;border:none!important;box-shadow:none!important;backdrop-filter:none!important;}
.card.layout-tablet .mobile-art-actions{position:relative!important;left:auto!important;right:auto!important;transform:none!important;inset-inline:auto!important;inset-block-end:auto!important;margin-top:-12px!important;margin-bottom:4px!important;z-index:4!important;}
.theme-light .mobile-art-actions{background:transparent!important;border-color:transparent!important;box-shadow:none!important;}
...
@media (max-width: 600px){.mobile-art-actions{gap:8px!important;padding:0!important;margin-top:-4px!important;}.mobile-art-actions.count-4{gap:8px!important;}.mobile-art-fab{width:38px;min-width:38px;height:38px;}}
