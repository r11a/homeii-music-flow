...
const HOMEII_CARD_VERSION = "4.7.10";
...
.control-room-grid-wrap{min-height:0;height:100%;padding:24px 28px 0;overflow:auto;display:block;}
.control-room-grid{width:100%;display:grid;grid-template-columns:repeat(auto-fit,minmax(clamp(320px, 28vw, 420px),1fr));gap:18px;align-content:start;justify-content:stretch;justify-items:stretch;margin-inline:auto;grid-auto-rows:max-content;}
