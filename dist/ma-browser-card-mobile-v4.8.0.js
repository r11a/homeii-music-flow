...
const HOMEII_CARD_VERSION = "4.8.0";
...
.player-sub { margin-top:1px; font-size:calc(11px * var(--v2-font-scale)); color:rgba(255,255,255,.72); white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
        ...
        .card:not(.empty-media) .center::before {
          content:"";
          position:absolute;
          inset-block-start:0;
          left:50%;
          ...
          border-radius:44px;
          background:
            radial-gradient(circle at 50% 16%, rgba(255,255,255,.16), transparent 56%),
            linear-gradient(180deg, rgba(255,255,255,.08), rgba(255,255,255,.03) 68%, transparent 100%);
          opacity:.9;
          pointer-events:none;
          z-index:0;
        }
        .theme-light.card:not(.empty-media) .center::before {
          background:
            radial-gradient(circle at 50% 16%, rgba(255,255,255,.28), transparent 56%),
            linear-gradient(180deg, rgba(255,255,255,.16), rgba(255,255,255,.06) 72%, transparent 100%);
          opacity:.92;
        }
        ...
        .theme-light .art-aura {
          opacity:.48;
          filter:blur(40px) saturate(1.03) brightness(1.04);
        }
        ...
        .art-stack-slide.prev {
          transform:translateX(calc(-94% + (var(--art-drag-x) * .22))) scale(.88);
          opacity:.32;
        }
        .art-stack-slide.next {
          transform:translateX(calc(-6% + (var(--art-drag-x) * .22))) scale(.88);
          opacity:.32;
        }
        ...
        .card.layout-tablet .art-stack-slide.prev {
          transform:translateX(calc(-96% + (var(--art-drag-x) * .2))) scale(.88);
          opacity:.28;
        }
        .card.layout-tablet .art-stack-slide.next {
          transform:translateX(calc(-4% + (var(--art-drag-x) * .2))) scale(.88);
          opacity:.28;
        }
        .card.layout-tablet .art-stack-slide.prev .art-stack-card {
          transform:perspective(1080px) rotateY(9deg) scale(.95);
        }
        ...
        .mobile-art-fab {
          position:static;
          width:46px; min-width:46px; height:46px; border-radius:999px; border:1px solid rgba(255,255,255,.12);
          background:rgba(14,18,28,.34); backdrop-filter:blur(12px); -webkit-backdrop-filter:blur(12px);
          color:#fff; display:grid; place-items:center; cursor:pointer; box-shadow:0 10px 22px rgba(0,0,0,.16);
        ...
        .card.layout-tablet.tablet-auto-fit .art-stack-container {
          min-height:clamp(190px, 21vw, 278px);
        }
        ...
        @media (max-width:600px) {
          ...
          .art-stack-view,
          .art-stack-viewport,
          .art-stack-container { min-height:min(44vw, 220px); }
          .art-stack-slide { width:68%; }
          .mobile-art-shell { width:min(292px, calc(100% - 32px)); border-radius:0; padding:0; }
          .np-art.mobile-art { border-radius:22px; }
          .mobile-art-actions { width:auto; margin-top:6px; padding:0; gap:8px; }
...
.mobile-art-actions{position:relative!important;left:auto!important;right:auto!important;transform:none!important;inset-inline:auto!important;inset-block-end:auto!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:12px!important;flex-wrap:wrap!important;margin-top:4px!important;padding:0!important;border-radius:0!important;background:transparent!important;border:none!important;box-shadow:none!important;backdrop-filter:none!important;}
.card.layout-tablet .mobile-art-actions{position:relative!important;left:auto!important;right:auto!important;transform:none!important;inset-inline:auto!important;inset-block-end:auto!important;margin-top:-2px!important;margin-bottom:6px!important;z-index:4!important;}
.theme-light .mobile-art-actions{background:transparent!important;border-color:transparent!important;box-shadow:none!important;}
        .mobile-art-fab{width:46px;min-width:46px;height:46px;border-radius:999px;}
...
@media (max-width: 600px){.mobile-art-actions{gap:8px!important;padding:0!important;margin-top:6px!important;}.mobile-art-actions.count-4{gap:10px!important;}.mobile-art-fab{width:40px;min-width:40px;height:40px;}}
