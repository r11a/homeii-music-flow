...
const HOMEII_CARD_VERSION = "4.7.2";
...
.control-room-body-host{min-height:0;height:100%;overflow:auto;padding:0;display:flex;}
.control-room-scene{position:relative;min-height:100%;width:100%;flex:1;padding:22px 26px 24px;display:grid;}
...
.control-room-scene.has-art .control-room-scene-bg{background:
  radial-gradient(circle at 16% 20%, rgba(var(--dynamic-accent-rgb,245 166 35) / .28), transparent 28%),
  radial-gradient(circle at 84% 18%, rgba(var(--dynamic-glow-rgb,255 175 92) / .2), transparent 24%),
  linear-gradient(180deg, rgba(7,10,17,.08), rgba(7,10,17,.56)),
  var(--control-room-scene-art) center/cover no-repeat;}
.control-room-scene-glow{background:
  radial-gradient(circle at 24% 24%, rgba(var(--dynamic-accent-rgb,245 166 35) / .24), transparent 30%),
  radial-gradient(circle at 76% 68%, rgba(var(--dynamic-glow-rgb,255 175 92) / .16), transparent 28%),
  linear-gradient(180deg, rgba(255,255,255,.02), rgba(255,255,255,0));
  mix-blend-mode:screen;opacity:.8;}
.theme-light .control-room-scene-glow{opacity:.58;}
.control-room-layout{position:relative;z-index:1;min-height:100%;display:grid;grid-template-rows:minmax(0,1fr) auto auto;gap:20px;}
.control-room-grid-wrap{min-height:0;padding-top:18px;display:flex;align-items:flex-start;}
.control-room-grid{width:100%;display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:20px;align-content:start;}
.control-room-tile{position:relative;min-height:340px;display:grid;grid-template-rows:minmax(0,1fr) auto auto;gap:12px;padding:18px;border-radius:30px;overflow:hidden;border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.05);box-shadow:0 18px 40px rgba(0,0,0,.18);transition:transform .24s ease,border-color .24s ease,box-shadow .24s ease,opacity .24s ease;transform-origin:center bottom;}
.control-room-tile:hover{transform:translateY(-3px);}
.control-room-tile.selected{transform:translateY(-14px) scale(1.045);border-color:rgba(var(--dynamic-accent-rgb,245 166 35) / .56);box-shadow:0 28px 64px rgba(0,0,0,.34),0 0 0 1px rgba(var(--dynamic-accent-rgb,245 166 35) / .16);z-index:2;}
.control-room-tile.primary{outline:1px solid rgba(255,255,255,.12);}
.control-room-grid:hover .control-room-tile:not(.selected){opacity:.94;}
...
.control-room-tile-shade{background:linear-gradient(180deg, rgba(10,13,20,.16) 0%, rgba(10,13,20,.1) 28%, rgba(10,13,20,.8) 100%);}
...
.control-room-tile-track{font-size:15px;font-weight:700;color:rgba(255,255,255,.92);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-shadow:0 8px 18px rgba(0,0,0,.28);}
.control-room-tile-name{font-size:30px;font-weight:900;line-height:1;letter-spacing:-.03em;color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-shadow:0 10px 24px rgba(0,0,0,.34);}
...
.control-room-tile-dock{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:10px;border-radius:20px;border:1px solid rgba(255,255,255,.12);background:rgba(9,12,18,.28);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);box-shadow:0 10px 26px rgba(0,0,0,.12);}
...
.control-room-volume-row{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:10px;padding:0 6px 2px;}
...
.control-room-tray{display:grid;gap:12px;align-self:end;max-width:min(1120px, 100%);margin-inline:auto;padding:14px 16px;border-radius:28px;border:1px solid rgba(255,255,255,.12);background:rgba(9,12,18,.34);backdrop-filter:blur(22px);-webkit-backdrop-filter:blur(22px);box-shadow:0 20px 48px rgba(0,0,0,.22);}
...
.control-room-dock{display:flex;align-items:center;justify-content:center;gap:12px;flex-wrap:wrap;max-width:max-content;margin-inline:auto;padding:14px 18px;border-radius:999px;border:1px solid rgba(255,255,255,.14);background:rgba(9,12,18,.34);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);box-shadow:0 18px 42px rgba(0,0,0,.22);transform:translateY(-2px);}
...
.control-room-selection-pill{display:inline-flex;align-items:center;justify-content:center;min-width:54px;height:54px;padding:0 16px;border-radius:999px;background:rgba(var(--dynamic-accent-rgb,245 166 35) / .24);border:1px solid rgba(var(--dynamic-accent-rgb,245 166 35) / .28);font-size:13px;font-weight:900;color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:220px;box-shadow:0 10px 24px rgba(0,0,0,.18);}
.theme-light .control-room-selection-pill{color:#433006;}
.control-room-dock-btn{width:54px;height:54px;padding:0;border-radius:18px;border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.08);color:#fff;display:grid;place-items:center;box-shadow:0 10px 24px rgba(0,0,0,.12);}
...
@media (max-width: 1280px){
  ...
  .control-room-tile{min-height:312px;}
