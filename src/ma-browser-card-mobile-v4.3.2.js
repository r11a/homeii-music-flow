...
const HOMEII_CARD_VERSION = "4.3.2";
          ...
          <div class="settings-color-wrap">
            ...
            <div class="night-window-grid">
              <label class="night-time-card" for="mobileNightStartInput">
                ...
                <input class="night-time-input" id="mobileNightStartInput" type="time" value="${this._esc(nightWindow.start)}">
              </label>
              <label class="night-time-card" for="mobileNightEndInput">
                <span class="night-time-label">${this._m("End time", "שעת סיום")}</span>
                <input class="night-time-input" id="mobileNightEndInput" type="time" value="${this._esc(nightWindow.end)}">
              </label>
            </div>
          </div>
          <div class="settings-hint">${this._m("Auto mode turns on between Start time and End time, even when the range crosses midnight.", "מצב Auto נכנס לפעולה בין שעת ההתחלה לשעת הסיום, גם אם הטווח חוצה חצות.")}</div>
