...
const HOMEII_CARD_VERSION = "4.6.1";
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        * { box-sizing:border-box; }
        ...
        .history-toggle-fab .ui-ic { width:20px; height:20px; }
        .history-toggle-fab.active {
          color:var(--ma-accent);
          background:rgba(245,166,35,.14);
          border-color:rgba(245,166,35,.3);
          box-shadow:0 18px 34px rgba(0,0,0,.24), 0 0 0 1px rgba(245,166,35,.12);
        }
        .history-toggle-fab:active {
...
@media (max-width: 820px){
  ...
  .history-toggle-fab{inset-block-end:20px;inset-block-start:auto;width:46px;height:76px;transform:none;}
  .history-toggle-fab:active{transform:scale(.97);}
