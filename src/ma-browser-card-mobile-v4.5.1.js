...
const HOMEII_CARD_VERSION = "4.5.1";
  ...
  _applyBackgroundMotionStyles() {
    ...
    const vars = mode === "strong"
      ? {
          ...
          "--bg-motion-shift": "26px",
          "--bg-motion-scale": "1.12",
          "--bg-motion-duration": "28s",
          "--glow-motion-duration": "20s",
          "--aura-motion-duration": "24s",
        }
      : {
          "--bg-motion-strength": "1",
          "--bg-motion-shift": "16px",
          "--bg-motion-scale": "1.09",
          "--bg-motion-duration": "38s",
          "--glow-motion-duration": "28s",
          "--aura-motion-duration": "32s",
        };
      ...
      <style>
        ...
        * { box-sizing:border-box; }
        ...
        @keyframes backgroundFloat {
          0% { transform:translate3d(0, 0, 0) scale(var(--bg-motion-scale, 1.09)); }
          33% { transform:translate3d(calc(var(--bg-motion-shift, 16px) * .55), calc(var(--bg-motion-shift, 16px) * -.45), 0) scale(calc(var(--bg-motion-scale, 1.09) + .015)); }
          66% { transform:translate3d(calc(var(--bg-motion-shift, 16px) * -.65), calc(var(--bg-motion-shift, 16px) * .4), 0) scale(calc(var(--bg-motion-scale, 1.09) + .03)); }
          100% { transform:translate3d(0, 0, 0) scale(var(--bg-motion-scale, 1.09)); }
        }
        @keyframes glowDrift {
          0% { transform:translate3d(0, 0, 0) scale(1); opacity:.92; }
          50% { transform:translate3d(calc(var(--bg-motion-shift, 16px) * -.42), calc(var(--bg-motion-shift, 16px) * .28), 0) scale(calc(1 + (.04 * var(--bg-motion-strength, 1)))); opacity:1; }
          100% { transform:translate3d(0, 0, 0) scale(1); opacity:.92; }
        }
        @keyframes auraDrift {
          0% { transform:translate3d(0, 0, 0) scale(1.08); }
          50% { transform:translate3d(calc(var(--bg-motion-shift, 16px) * .22), calc(var(--bg-motion-shift, 16px) * -.18), 0) scale(calc(1.08 + (.025 * var(--bg-motion-strength, 1)))); }
