        ...
        <div class="control-room-layout">
          ...
          <div class="control-room-dock">
            ...
            <div class="control-room-dock-section room">
              <span class="control-room-selection-pill">${this._esc(selectedIds.length > 1 ? `${selectedIds.length}` : "1")}</span>
...
const HOMEII_CARD_VERSION = "4.7.4";
...
.control-room-grid-wrap{min-height:0;padding:28px 34px 138px;display:flex;align-items:flex-start;justify-content:center;}
.control-room-grid{width:100%;max-width:min(1760px, calc(100% - 48px));display:grid;grid-template-columns:repeat(auto-fit,minmax(310px,360px));gap:18px;align-content:start;justify-content:center;justify-items:center;margin-inline:auto;}
.control-room-tile{position:relative;width:100%;max-width:360px;aspect-ratio:16 / 9;display:grid;grid-template-rows:minmax(0,1fr) auto;gap:10px;padding:16px 16px 14px;border-radius:28px;overflow:hidden;border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.05);box-shadow:0 18px 40px rgba(0,0,0,.18);transition:transform .24s ease,border-color .24s ease,box-shadow .24s ease,opacity .24s ease,filter .24s ease;transform-origin:center bottom;}
.control-room-tile:hover{transform:translateY(-3px);}
.control-room-tile.selected{transform:translateY(-16px) scale(1.04);border-color:rgba(var(--dynamic-accent-rgb,245 166 35) / .56);box-shadow:0 30px 72px rgba(0,0,0,.38),0 0 0 1px rgba(var(--dynamic-accent-rgb,245 166 35) / .18);z-index:3;filter:saturate(1.04);}
...
.control-room-select-fab{position:absolute;inset-block-start:14px;inset-inline-end:14px;width:38px;height:38px;padding:0;border-radius:14px;border:1px solid rgba(255,255,255,.12);background:rgba(9,12,18,.24);color:#fff;display:grid;place-items:center;backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);}
...
.control-room-volume-row{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:10px;padding:0 4px 0;}
...
.control-room-dock{position:absolute;inset-inline-start:50%;inset-block-end:28px;display:flex;align-items:center;justify-content:center;gap:14px;flex-wrap:nowrap;max-width:calc(100% - 44px);margin-inline:auto;padding:14px 18px;border-radius:999px;border:1px solid rgba(255,255,255,.14);background:rgba(9,12,18,.42);backdrop-filter:blur(24px);-webkit-backdrop-filter:blur(24px);box-shadow:0 22px 52px rgba(0,0,0,.28);transform:translateX(-50%);}
...
@media (max-width: 1280px){
  ...
  .control-room-grid{grid-template-columns:repeat(auto-fit,minmax(250px,300px));gap:16px;max-width:calc(100% - 12px);}
  .control-room-tile{max-width:300px;}
  ...
  .control-room-dock{inset-block-end:18px;padding:12px 14px;gap:10px;max-width:calc(100% - 24px);}
