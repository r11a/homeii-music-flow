...
const HOMEII_CARD_VERSION = "4.6.3";
...
@media (max-width: 820px){
  ...
  .history-toggle-fab{inset-block-start:46%;inset-block-end:auto;width:34px;height:58px;border-radius:14px;transform:translateY(-50%);opacity:.76;}
