...
const HOMEII_CARD_VERSION = "4.2.3";
      ...
      <style>
        ...
        * { box-sizing:border-box; }
        ...
        .compact-mute-btn {
          ...
          background:rgba(120,66,41,.42) !important;
          border:1px solid rgba(255,255,255,.12) !important;
          box-shadow:none !important;
        }
        .theme-light .compact-shell {
          ...
          background:
            ...
            rgba(117,132,80,.28);
          box-shadow:
            0 24px 52px rgba(33,39,22,.22),
            inset 0 1px 0 rgba(255,255,255,.14);
        }
        .theme-light .compact-backdrop-art {
          opacity:.7;
          filter:blur(56px) saturate(1.22) brightness(.88);
        }
        .theme-light .compact-backdrop-shade {
          background:
            radial-gradient(circle at 18% 22%, rgba(245,232,182,.18), transparent 24%),
            linear-gradient(180deg, rgba(76,89,49,.36), rgba(54,60,34,.46)),
            rgba(39,42,28,.34);
        }
        .theme-light .compact-sheen {
          background:
            radial-gradient(circle at 16% 18%, rgba(255,220,160,.2), transparent 24%),
            radial-gradient(circle at 72% 56%, rgba(255,255,255,.08), transparent 30%),
            radial-gradient(circle at 50% 100%, rgba(141,96,49,.18), transparent 24%);
        }
