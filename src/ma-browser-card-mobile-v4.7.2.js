...
const HOMEII_CARD_VERSION = "4.7.3";
...
.control-room-grid-wrap{min-height:0;padding:28px 34px 132px;display:flex;align-items:center;justify-content:center;}
.control-room-grid{width:100%;max-width:min(1720px, calc(100% - 48px));display:grid;grid-template-columns:repeat(auto-fit,minmax(248px,280px));gap:22px;align-content:center;justify-content:center;justify-items:center;margin-inline:auto;}
.control-room-tile{position:relative;width:100%;max-width:280px;min-height:408px;display:grid;grid-template-rows:minmax(0,1fr) auto auto;gap:14px;padding:18px 18px 16px;border-radius:32px;overflow:hidden;border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.05);box-shadow:0 18px 40px rgba(0,0,0,.18);transition:transform .24s ease,border-color .24s ease,box-shadow .24s ease,opacity .24s ease,filter .24s ease;transform-origin:center bottom;}
.control-room-tile:hover{transform:translateY(-3px);}
.control-room-tile.selected{transform:translateY(-22px) scale(1.085);border-color:rgba(var(--dynamic-accent-rgb,245 166 35) / .56);box-shadow:0 34px 82px rgba(0,0,0,.42),0 0 0 1px rgba(var(--dynamic-accent-rgb,245 166 35) / .18);z-index:3;filter:saturate(1.04);}
...
.control-room-tile[style*='--control-room-tile-art'] .control-room-tile-bg{background:var(--control-room-tile-art) center/cover no-repeat;filter:saturate(1.08);}
...
.control-room-tile-track{font-size:14px;font-weight:700;color:rgba(255,255,255,.82);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-shadow:0 8px 18px rgba(0,0,0,.28);}
.control-room-tile-name{font-size:34px;font-weight:900;line-height:.98;letter-spacing:-.035em;color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-shadow:0 10px 24px rgba(0,0,0,.34);}
...
.control-room-tile-dock{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:10px 12px;border-radius:22px;border:1px solid rgba(255,255,255,.12);background:rgba(9,12,18,.34);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);box-shadow:0 10px 26px rgba(0,0,0,.12);}
.theme-light .control-room-tile-dock{background:rgba(255,255,255,.58);border-color:rgba(28,42,68,.08);}
.control-room-chip-btn{width:44px;height:44px;padding:0;border-radius:16px;border:1px solid rgba(255,255,255,.08);background:rgba(255,255,255,.08);color:#fff;display:grid;place-items:center;}
...
.control-room-volume-row{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:10px;padding:0 8px 4px;}
...
.control-room-dock{position:absolute;inset-inline-start:50%;inset-block-end:28px;display:flex;align-items:center;justify-content:center;gap:12px;flex-wrap:nowrap;max-width:calc(100% - 44px);margin-inline:auto;padding:16px 20px;border-radius:999px;border:1px solid rgba(255,255,255,.14);background:rgba(9,12,18,.38);backdrop-filter:blur(24px);-webkit-backdrop-filter:blur(24px);box-shadow:0 22px 52px rgba(0,0,0,.28);transform:translateX(-50%);}
...
.control-room-selection-pill{display:inline-flex;align-items:center;justify-content:center;min-width:68px;height:60px;padding:0 20px;border-radius:999px;background:rgba(var(--dynamic-accent-rgb,245 166 35) / .28);border:1px solid rgba(var(--dynamic-accent-rgb,245 166 35) / .32);font-size:13px;font-weight:900;color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:260px;box-shadow:0 12px 28px rgba(0,0,0,.22);}
.theme-light .control-room-selection-pill{color:#433006;}
.control-room-dock-btn{width:60px;height:60px;padding:0;border-radius:20px;border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.08);color:#fff;display:grid;place-items:center;box-shadow:0 10px 24px rgba(0,0,0,.12);}
...
@media (max-width: 1280px){
  .control-room-grid-wrap{padding:26px 24px 124px;}
  .control-room-grid{grid-template-columns:repeat(auto-fit,minmax(220px,252px));gap:18px;max-width:calc(100% - 12px);}
  .control-room-tile{min-height:360px;max-width:252px;}
  .control-room-tile.selected{transform:translateY(-14px) scale(1.05);}
  .control-room-tray{inset-block-end:102px;width:min(1080px, calc(100% - 36px));}
  .control-room-dock{inset-block-end:18px;padding:12px 14px;gap:10px;}
