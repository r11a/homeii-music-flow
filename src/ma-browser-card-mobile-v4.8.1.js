...
const HOMEII_CARD_VERSION = "4.8.1";
...
.player-sub { margin-top:1px; font-size:calc(11px * var(--v2-font-scale)); color:rgba(255,255,255,.72); white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
        ...
        .art-aura {
          ...
          border-radius:999px;
          background:center / cover no-repeat;
          filter:blur(52px) saturate(1.03);
          opacity:.5;
          transform:translate(-50%, -24%) scale(1.04);
          pointer-events:none;
          will-change:transform, opacity;
        }
        .theme-light .art-aura {
          opacity:.36;
          filter:blur(56px) saturate(1.01) brightness(1.03);
        }
        ...
        .card.dynamic-theme .art-aura {
          filter:blur(56px) saturate(calc(1.02 + (.08 * var(--dynamic-theme-strength, .82))));
          opacity:calc(.32 + (.16 * var(--dynamic-theme-strength, .82)));
          mix-blend-mode:screen;
        }
        .theme-light.card.dynamic-theme .art-aura {
          opacity:calc(.24 + (.1 * var(--dynamic-theme-strength, .82)));
        }
        .art-stack-view {
          position:relative;
          width:100%;
