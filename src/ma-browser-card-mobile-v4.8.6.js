...
const HOMEII_CARD_VERSION = "4.8.6";
...
class MABrowserCardMobile extends MABrowserCard {
  ...
  _build() {
    ...
    const bottomHtml = `
        ...
        <div class="media-float-stack" id="mediaDock">
          <div class="progress-line media-progress-line">
          ...
          ${dockVolumeHtml ? `<div class="media-volume-line">${dockVolumeHtml}</div>` : ``}
        </div>
        ${smartShelfHtml}
      </div>`;
...
.player-sub { margin-top:1px; font-size:calc(11px * var(--v2-font-scale)); color:rgba(255,255,255,.72); white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
        ...
        .bottom { display:grid; width:100%; max-width:100%; min-width:0; gap:14px; align-content:end; }
        ...
        .media-float-stack {
          ...
          display:grid;
          gap:18px;
          padding:4px clamp(8px, 1vw, 14px) 0;
        }
        .card.layout-tablet .media-float-stack {
          gap:16px;
          padding-inline:clamp(10px, 1.2vw, 18px);
        }
        .media-float-stack .progress-line,
        .media-float-stack .controls,
        .media-float-stack .mobile-volume-inline {
          width:100%;
          margin-inline:0;
        }
        .media-float-stack .progress-line {
        ...
        .media-float-stack .progress-time {
          min-width:56px;
          font-size:14px;
          font-weight:800;
        ...
        .card.layout-tablet .media-float-stack .progress-time {
          font-size:15px;
          min-width:60px;
        }
        .media-float-stack .progress {
          height:8px;
          background:linear-gradient(90deg, rgba(255,255,255,.12), rgba(255,255,255,.06));
          box-shadow:none;
          overflow:visible;
        }
        .media-float-stack .progress-fill {
          border-radius:999px;
          box-shadow:0 0 18px color-mix(in srgb, var(--ma-accent) 24%, transparent);
        }
        .theme-light .media-float-stack .progress {
          background:linear-gradient(90deg, rgba(96,112,134,.16), rgba(96,112,134,.08));
        }
        .theme-light .media-float-stack .progress-time {
          color:#364559;
          text-shadow:none;
        }
        .media-controls {
        ...
        .media-controls .side-btn,
        .media-controls .main-btn,
        .media-volume-line .volume-btn {
          ...
          box-shadow:
            ...
            0 8px 18px rgba(var(--dynamic-glow-rgb, 255 178 56) / .08),
            inset 0 1px 0 rgba(255,255,255,.06);
        }
        .theme-light .media-controls .side-btn,
        .theme-light .media-controls .main-btn,
        .theme-light .media-volume-line .volume-btn {
          background:linear-gradient(160deg, rgba(255,255,255,.9), rgba(244,248,252,.52));
          border-color:rgba(143,159,181,.16);
          box-shadow:
            0 18px 30px rgba(96,112,134,.12),
            0 8px 16px rgba(var(--dynamic-glow-rgb, 255 178 56) / .06),
            inset 0 1px 0 rgba(255,255,255,.82);
        }
        .card.layout-tablet .media-controls .side-btn,
        .card.layout-tablet .media-volume-line .volume-btn {
          width:62px;
          height:62px;
          border-radius:999px;
        }
        .card.layout-tablet .media-controls .side-btn.minor-btn {
          width:52px;
          height:52px;
        }
        .card.layout-tablet .media-controls .main-btn {
          width:104px;
          height:104px;
        }
        .media-volume-line {
        ...
        .media-volume-line .mobile-volume-inline {
          gap:18px;
          align-items:center;
        }
        .media-volume-line .volume-value {
          min-width:60px;
          font-size:14px;
          font-weight:900;
          color:rgba(255,255,255,.72);
        }
        .theme-light .media-volume-line .volume-value {
          color:#516177;
        }
        .media-volume-line .volume-slider {
          height:6px;
          background:linear-gradient(to right,var(--ma-accent) 0%,var(--ma-accent) var(--vol-pct,50%),rgba(255,255,255,.12) var(--vol-pct,50%),rgba(255,255,255,.12) 100%);
          box-shadow:none;
        }
        .theme-light .media-volume-line .volume-slider {
          background:linear-gradient(to right,var(--ma-accent) 0%,var(--ma-accent) var(--vol-pct,50%),rgba(96,112,134,.12) var(--vol-pct,50%),rgba(96,112,134,.12) 100%);
        }
        .media-volume-line .volume-slider::-webkit-slider-thumb {
          width:18px;
          height:18px;
          border:2px solid rgba(255,255,255,.68);
          box-shadow:0 8px 16px rgba(0,0,0,.14);
        }
        .media-volume-line .volume-slider::-moz-range-thumb {
          width:18px;
          height:18px;
          border:2px solid rgba(255,255,255,.68);
          box-shadow:0 8px 16px rgba(0,0,0,.14);
        ...
        .smart-shelf {
          ...
          display:grid;
          gap:16px;
          padding:2px clamp(8px, 1vw, 14px) 0;
          background:transparent;
          border:none;
          box-shadow:none;
          backdrop-filter:none;
        ...
        .smart-shelf-tab {
          ...
          place-items:center;
          cursor:pointer;
          transition:transform .16s ease, background-color .16s ease, border-color .16s ease, box-shadow .16s ease, opacity .16s ease, color .16s ease;
          backdrop-filter:blur(10px);
          -webkit-backdrop-filter:blur(10px);
        ...
        .smart-shelf-tab.active {
          ...
          border-color:color-mix(in srgb, var(--ma-accent) 36%, rgba(255,255,255,.1));
          box-shadow:0 12px 22px color-mix(in srgb, var(--ma-accent) 16%, transparent);
        }
        ...
        .theme-light .smart-shelf-tab {
          ...
          box-shadow:0 10px 18px rgba(96,112,134,.08), inset 0 1px 0 rgba(255,255,255,.72);
        }
        .smart-shelf-track {
          display:flex;
          align-items:flex-start;
        ...
        .smart-shelf-art {
          ...
          box-shadow:
            ...
            0 6px 16px rgba(var(--dynamic-glow-rgb, 255 178 56) / .08),
            inset 0 1px 0 rgba(255,255,255,.08);
        }
        .smart-shelf-art img {
          width:100%;
        ...
        .theme-light .smart-shelf-art {
          background:linear-gradient(160deg, rgba(255,255,255,.92), rgba(241,246,251,.56));
          border-color:rgba(143,159,181,.14);
          box-shadow:
            0 14px 24px rgba(96,112,134,.12),
            0 6px 14px rgba(var(--dynamic-glow-rgb, 255 178 56) / .05),
        ...
        .theme-light .smart-shelf-bubble {
          background:rgba(255,255,255,.76);
          border-color:rgba(143,159,181,.14);
          box-shadow:0 8px 16px rgba(96,112,134,.08);
          color:#314154;
        }
...
@media (max-width: 1280px){
  ...
  _smartShelfModeIcon(mode = "queue") {
    if (mode === "recent") return "tracks";
    if (mode === "for_you") return "wand";
    return "queue";
  }
  ...
  _smartShelfCardHtml(item = {}, index = 0) {
    ...
    return `
      <button
        ...
        aria-label="${this._esc(title)}"
      >
        <span class="smart-shelf-art">${art ? `<img src="${this._esc(art)}" alt="">` : this._iconSvg(mediaType === "radio" ? "radio" : mediaType === "playlist" ? "queue" : "music_note")}</span>
        <span class="smart-shelf-bubble">${this._esc(title)}</span>
      </button>
    `;
  }
    ...
    const bodyHtml = loadingForYou && activeMode === "for_you"
      ? Array.from({ length: this._layoutModeConfig() === "tablet" ? 4 : 3 }, (_, index) => `
          <div class="smart-shelf-card skeleton" aria-hidden="true" data-smart-shelf-skeleton="${index}">
            ...
            <span class="smart-shelf-bubble smart-shelf-line long"></span>
          </div>
        `).join("")
      : items.length
    ...
    const nextHtml = `
      <div class="smart-shelf-head">
        <div class="smart-shelf-tabs">
          ${tabs.map((tab) => `
            <button
              class="smart-shelf-tab ${activeMode === tab.mode ? "active" : ""}"
              data-smart-shelf-mode="${this._esc(tab.mode)}"
              title="${this._esc(tab.label)}"
              aria-label="${this._esc(tab.label)}"
              ${tab.disabled ? "disabled" : ""}
            >
              ${this._iconSvg(this._smartShelfModeIcon(tab.mode))}
            </button>
          `).join("")}
        </div>
      </div>
