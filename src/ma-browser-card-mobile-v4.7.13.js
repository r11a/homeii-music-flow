...
const HOMEII_CARD_VERSION = "4.7.13";
...
.control-room-tile-track{font-size:13px;font-weight:700;color:rgba(255,255,255,.86);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-shadow:0 8px 18px rgba(0,0,0,.34);}
.control-room-tile-name{font-size:22px;font-weight:850;line-height:1.02;letter-spacing:-.024em;color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-shadow:0 12px 28px rgba(0,0,0,.4);}
.control-room-tile-state{font-size:12px;font-weight:700;color:rgba(255,255,255,.7);}
...
.control-room-dock-label{font-size:12px;font-weight:800;white-space:nowrap;}
