...
const HOMEII_CARD_VERSION = "4.7.14";
...
class MABrowserCardMobile extends MABrowserCard {
  ...
  _toggleSleepTimerMenu(force = null) {
    ...
    this._state.mobileSleepTimerMenuOpen = !!next && this._sleepTimerRemainingMs() > 0;
    this._syncSleepTimerChip();
  }
  ...
  _build() {
    ...
    const historyToggleFabHtml = !compactTileMode
      ...
      : ``;
    const sleepTimerCornerHtml = !compactTileMode && sleepTimerActive ? `
