        ...
        <div class="control-room-layout">
          ...
          <div class="control-room-dock">
            ...
            <div class="control-room-dock-section room">
              ...
              <button class="control-room-dock-btn library-pill ${this._state.controlRoomPanel === "library" ? "active" : ""}" data-room-selection-action="library" title="${this._esc(this._m("Media library", "ספריית מדיה"))}">
...
const HOMEII_CARD_VERSION = "4.7.8";
...
.control-room-grid-wrap{min-height:0;height:100%;padding:24px 28px 58px;display:flex;align-items:stretch;justify-content:center;}
...
@media (max-width: 1280px){
  .control-room-grid-wrap{padding:24px 20px 72px;}
  ...
  .control-room-dock{inset-block-end:-1px;padding:12px 14px calc(14px + env(safe-area-inset-bottom, 0px));gap:10px;max-width:calc(100% - 2px);}
