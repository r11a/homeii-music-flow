          ...
          <div class="control-room-dock">
            ...
            <div class="control-room-dock-section room">
              ...
              <button class="control-room-dock-btn library-pill" data-room-selection-action="browse_library" title="${this._esc(this._m("Media library", "ספריית מדיה"))}">
                ...
                <span class="control-room-dock-label">${this._esc(this._m("Library", "ספריה"))}</span>
              </button>
...
const HOMEII_CARD_VERSION = "4.7.11";
...
.control-room-tile-name{font-size:30px;font-weight:900;line-height:.98;letter-spacing:-.035em;color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-shadow:0 12px 28px rgba(0,0,0,.4);}
...
.control-room-dock-btn.library-pill{width:auto;min-width:120px;padding:0 16px;display:inline-flex;align-items:center;gap:8px;}
...
@media (max-width: 1280px){
  ...
  .control-room-dock-btn.library-pill{min-width:104px;padding:0 12px;}
    ...
    this.$("controlRoomBackdrop")?.addEventListener("click", async (e) => {
      ...
      if (dockBtn) {
        ...
        if (action === "browse_library") {
          this._openMobileMenu("library_playlists");
          return;
        }
