...
const HOMEII_CARD_VERSION = "4.7.9";
...
.control-room-layout{position:relative;z-index:1;height:100%;min-height:100%;display:grid;grid-template-rows:minmax(0,1fr);}
.control-room-grid-wrap{min-height:0;height:100%;padding:24px 28px 22px;display:flex;align-items:stretch;justify-content:center;}
...
.control-room-dock{position:absolute;left:50%;bottom:0;display:flex;align-items:center;justify-content:center;gap:14px;flex-wrap:nowrap;max-width:calc(100% - 8px);margin-inline:auto;padding:14px 18px calc(18px + env(safe-area-inset-bottom, 0px));border-radius:28px 28px 0 0;border:1px solid rgba(255,255,255,.14);border-bottom:none;background:rgba(9,12,18,.52);backdrop-filter:blur(24px);-webkit-backdrop-filter:blur(24px);box-shadow:0 10px 28px rgba(0,0,0,.22);transform:translateX(-50%);}
...
@media (max-width: 1280px){
  .control-room-grid-wrap{padding:24px 20px 18px;}
  ...
  .control-room-dock{bottom:0;padding:12px 14px calc(14px + env(safe-area-inset-bottom, 0px));gap:10px;max-width:calc(100% - 2px);}
